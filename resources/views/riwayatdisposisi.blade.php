...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/riwayatdisposisi.css">
    ...
    <body>
            ...
            <div class="container py-6">
                <div class="card-header" style="background-color: blue; color: white; border-bottom: 2px solid white;">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <span class="font-weight-bold" style="font-size: 30px;">Riwayat Disposisi</span>
                        </div>
                    </div>
        ...
        <script src="js/riwayatdisposisi.js"></script>
    </body>
