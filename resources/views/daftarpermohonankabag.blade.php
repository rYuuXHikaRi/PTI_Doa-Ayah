...
<head>
    ...
    <link rel="stylesheet" href="css/daftarpermohonankabag.css">
                    ...
                    <div class="card rounded shadow border-2"> 
                        <div class="card-body p-5 bg-white rounded">
                            <div class="button-container">
                                <div class="button" id="suratMasuk">Sudah Ditandatangani</div>
                                <div class="button" id="suratKeluar">Belum Ditandatangani</div>
                              </div>
...
<script src="js/daftarpermohonankabag.js"></script>
</body>
</html>
