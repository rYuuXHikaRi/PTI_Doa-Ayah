    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <p class="font-weight-bold">Perihal: {{ $request->perihal }}</p>
                ...
                <ul>
                    <li>Hari/Tanggal : {{ $request->hari_tanggal }}</li>
                    <li>Waktu : {{ $request->waktu }}</li>
                    <li>Tempat : {{ $request->tempat }}</li>
                </ul>
                ...
                <p class="text-right">Bandar Jaya, {{ $request->tanggal_surat }}<br>
