                            ...
                            <div class="card-header" style="background-color: blue; color: white; border-bottom: 2px solid white;">
                                ...
                                <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="{{route('disposisi.tambahdisposisi' , ['id'=>$suratkeluarr->id,'status'=>"ditolak"])}}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('POST')
                                                    ...
                                                    <div class="col-md-8">
                                                        <button type="submit" class="btn btn-danger" style="background-color: red;color:white">Tolak</button>
                                                    </div>
                                            </form>
