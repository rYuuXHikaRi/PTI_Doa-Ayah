                                                ...
                                                @foreach ($suratkeluar as $suratkeluarr)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a role="button"  class="delete-button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm{{$suratkeluarr->id}}"><button
                                                        ...
                                                        <div class="modal fade bd-example-modal-sm{{$suratkeluarr->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer" style="left:0px; height: 80px;">
                                                                        <form action="{{route('suratkeluar.destroy', $suratkeluarr->id)}}" method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
