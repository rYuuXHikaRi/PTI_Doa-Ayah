        ...
        <div class="container py-6">
            <div class="card-header" style="background-color: blue; color: white; border-bottom: 2px solid white;">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                      <button id="btnTambahSurat" class="btn btn-primary" style="font-size: 15px; border-radius: 20px;">Tambah Surat Baru</button>
                  </div>
                  
                  <!-- The modal (popup) -->
                  <div id="myModal" class="modal">
                          <span class="close" id="closeModal">&times;</span><br>
                          <button class="btn btn-primary">Upload Surat Masuk</button>
                          <button class="btn btn-primary">Upload Surat Keluar</button>
                  </div>
                  ...
                  var btn = document.getElementById("btnTambahSurat");
