...
<head>
  ...
  <link rel="stylesheet" href="css/templateundangan.css">
</head>
<body>
  <div class="container">
    <div class="header">
    ...
    <ul>
        <li> Hari/Tanggal <div class="awal">: Rabu, 11 Oktober 2023</div></li>
        <li> Waktu <div class="kedua">: Pukul 09.00 WIB (Ontime) s/d selesai</div></li>
        <li> Tempat <div class="ketiga">: Lahan Belakang RSI</div></li>
    </ul>
